...
namespace LOGIN_AND_CRUD
{
    public partial class Form4 : Form
    {
        ...
        // 1.Inesrt data in table (insert Button code)
        private void button3_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\project\DB\empdata.mdf;Integrated Security=True;Connect Timeout=30");
            con.Open();
        ...
        //Delete Data in Table (Delete Button code)
        ...
        {
            // TODO: This line of code loads data into the 'empdataDataSet.studentinfo' table. You can move, or remove it, as needed.
